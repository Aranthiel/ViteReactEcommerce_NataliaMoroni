    ...
    return (
        <div>
            <div>
                ...
                <ul>
                    <li><Link to="https://www.linkedin.com/in/tu_perfil_de_linkedin" target="_blank">LinkedIn</Link></li>
                    <li><Link to="https://github.com/tu_perfil_de_github" target="_blank">GitHub</Link></li>
                </ul>
            </div>

            <div>
                <h2>Sobre este proyecyo</h2>
                <p>
